...
var TaroNode = /*@__PURE__*/(function (TaroEventTarget) {
     ...
     */
    TaroNode.prototype.insertAdjacentHTML = function insertAdjacentHTML (position, html) {
        var _a, _b;
        var parsedNodes = parser(html);
...
function createPageConfig(component, pageName, data, pageConfig) {
    ...
    var config = {
        onLoad: function onLoad(options, cb) {
            ...
            var mount = function () {
                Current.app.mount(component, this$1.$taroPath, function () {
                    pageElement = document$1.getElementById(this$1.$taroPath);
                    shared.ensure(pageElement !== null, '没有找到页面实例。');
                    safeExecute(this$1.$taroPath, 'onLoad', this$1.$taroParams);
                    if (!isBrowser) {
        ...
        onUnload: function onUnload() {
            ...
            Current.app.unmount(this.$taroPath, function () {
                unmounting = false;
                instances.delete(this$1.$taroPath);
                if (pageElement) {
